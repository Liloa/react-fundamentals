 ...
 * woo syntactic sugar because sugar makes it easier (learned from ics 313)
 * ... :(  answer shows up in the head as compiled jsx and not actually rendered on the dom
 * hard to see script show up in the head when theres compile errors in the console and its not open
 [x] Extra credit 1
 [x] Extra credit 2
## Background
